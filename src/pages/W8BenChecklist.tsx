...
// @ts-expect-error lucide-react@1.21.0 type declarations omit CheckSquare/Square/ListChecks (runtime-valid). Do NOT upgrade to 0.x — different API breaks all icon imports.
